...
**Cross com:** `live-commerce`, `zeus-co-cmo:cmo-marketing-ops-martech`.
...
**Cross com:** `zeus-co-cmo:cmo-pesquisa-insights`, `cino-tech-scouting`.
...
**Cross com:** `zeus-co-cmo:cmo-marketing-ops-martech`, `cco-brand-guardian`.
...
Escrever 1 linha em `~/Documents/Claude/Projects/_Pulse/skill-feedback/video-vision-analysis-YYYY-MM-DD.md`:
```
- YYYY-MM-DD HH:MM · video-vision-analysis · ambiente=cowork-chat · sucesso=[1-5] · gap=[gap ou "nenhum"] · sugestao=[1 frase] · empresa=[<empresa>]
```
...
```
- YYYY-MM-DD HH:MM · video-vision-analysis · ambiente=[cron-launchd|scheduled-task] · sucesso=auto · gap=[detectado via heurística: missing canônico, timeout, error] · sugestao=[se aplicável] · empresa=[<empresa>]
```
...
### 🤝 Peers
- `zeus-co-cmo:cmo-pesquisa-insights` (UC5 competitive)
- `zeus-co-cmo:cmo-marketing-ops-martech` (UC3 e UC7 — cross dados quanti)

...
Escrever 1 linha em `~/Documents/Claude/Projects/_Pulse/skill-feedback/cro-customer-success-YYYY-MM-DD.md`:
```
- YYYY-MM-DD HH:MM · cro-customer-success · ambiente=cowork-chat · sucesso=[1-5] · gap=[gap ou "nenhum"] · sugestao=[1 frase] · empresa=[<empresa>]
```
...
```
- YYYY-MM-DD HH:MM · cro-customer-success · ambiente=[cron-launchd|scheduled-task] · sucesso=auto · gap=[detectado via heurística: missing canônico, timeout, error] · sugestao=[se aplicável] · empresa=[<empresa>]
```

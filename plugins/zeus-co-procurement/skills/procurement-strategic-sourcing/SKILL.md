...
Escrever 1 linha em `~/Documents/Claude/Projects/_Pulse/skill-feedback/procurement-strategic-sourcing-YYYY-MM-DD.md`:
```
- YYYY-MM-DD HH:MM · procurement-strategic-sourcing · ambiente=cowork-chat · sucesso=[1-5] · gap=[gap ou "nenhum"] · sugestao=[1 frase] · empresa=[<empresa>]
```
...
```
- YYYY-MM-DD HH:MM · procurement-strategic-sourcing · ambiente=[cron-launchd|scheduled-task] · sucesso=auto · gap=[detectado via heurística: missing canônico, timeout, error] · sugestao=[se aplicável] · empresa=[<empresa>]
```

...
## Fim de sessão
1. LEARNINGS.md · procurement-strategic-sourcing · [lição] · [importa]
2. BACKLOG.md · [P0|P1|P2] · [ação] · Owner
3. _LEDGER.md · procurement-strategic-sourcing · [rfp|rfq|negotiation|outro] · ~N turnos · path
4. _Inbox.md opcional

**Fallback:** `_SessionRecaps/YYYY-MM-DD-sourcing.md`.
